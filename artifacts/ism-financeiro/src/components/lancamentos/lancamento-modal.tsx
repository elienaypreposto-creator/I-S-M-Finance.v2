...
function ParceiroCombobox({
    ...
    // Limpa a busca para não manter filtro residual
    ...
    return (
        <Popover open={open} onOpenChange={handleOpenChange}>
            <PopoverTrigger asChild>
              ...
              <span
                  className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${selected.tipo_pessoa === "PJ" ? "bg-primary/20 text-primary" : "bg-teal-500/20 text-teal-400"}`}>
                ...
                <div className="max-h-56 overflow-y-auto">
                    ...
                    {isLoading ? (
                        ...
                        parceiros.map((p) => (
                            ...
                            >
                <span
                    className={`text-[10px] font-bold px-1.5 py-0.5 rounded shrink-0 ${p.tipo_pessoa === "PJ" ? "bg-primary/20 text-primary" : "bg-teal-500/20 text-teal-400"}`}>
                  {p.tipo_pessoa}
                </span>
            ...
            <div
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6 overflow-y-auto">
                    ...
                    <div className="flex gap-4 pt-4 border-t border-white/5">
                        <button type="button" onClick={onClose}
                                className="px-8 py-3 rounded-xl border border-white/10 text-white hover:bg-white/5 text-sm font-bold transition-all">
                            Cancelar
                        </button>
                        <button
                            type="submit"
