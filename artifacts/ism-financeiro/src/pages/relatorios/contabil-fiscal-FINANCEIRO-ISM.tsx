...
const lancamentos = [
    {
        data: "05/06/2024",
        dataPgto: "05/06/2024",
        documento: "NFS-001234",
        descricao: "Prestação de Serviços - Junho",
        parceiro: "Tech Solutions S.A.",
        contaBancaria: "Itaú CC 56789-0",
        valor: 15000,
        tipo: "cr",
        categoria: "1.01 Receita de Serviços"
    },
    {
        data: "10/06/2024",
        dataPgto: "10/06/2024",
        documento: "NFS-001235",
        descricao: "Projeto Implementação",
        parceiro: "Global Industries",
        contaBancaria: "Itaú CC 56789-0",
        valor: 35000,
        tipo: "cr",
        categoria: "1.01 Receita de Serviços"
    },
    {
        ...
        dataPgto: "25/06/2024",
        documento: "NF-004567",
        descricao: "AWS - Serviços de Cloud",
        parceiro: "Amazon Web Services",
        contaBancaria: "Bradesco CC 98765-4",
        valor: 4500,
        tipo: "cp",
        categoria: "2.02 Fornecedores CSP"
    },
    {
        data: "28/06/2024",
        dataPgto: "28/06/2024",
        documento: "RPA-00089",
        descricao: "Pagamento PJ - Dev Sr.",
        parceiro: "João Silva",
        contaBancaria: "Bradesco CC 98765-4",
        valor: 8000,
        tipo: "cp",
        categoria: "2.01 Folha PJ"
    },
    {
        data: "30/06/2024",
        dataPgto: "30/06/2024",
        ...
        parceiro: "Imobiliária Central",
        contaBancaria: "Nubank PJ 11223344-5",
        valor: 3200,
        tipo: "cp",
        categoria: "3.03 Ocupação"
    },
    {
        data: "30/06/2024",
        dataPgto: "30/06/2024",
        documento: "TRANSF-001",
        descricao: "ISS Retido Junho",
        parceiro: "Prefeitura SP",
        contaBancaria: "Bradesco CC 98765-4",
        valor: 1800,
        tipo: "cp",
        categoria: "3.01 Administrativas"
    },
    {
        data: "30/06/2024",
        dataPgto: "30/06/2024",
        documento: "NFS-001236",
        descricao: "Serviços Consultoria",
        parceiro: "Alpha Consultoria",
        contaBancaria: "Itaú CC 56789-0",
        valor: 22000,
        tipo: "cr",
        categoria: "1.01 Receita de Serviços"
                    ...
                    <div className="glass-panel rounded-2xl overflow-hidden">
                        <div className="p-4 border-b border-white/5 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground mt-0.5">Colunas conforme solicitado pela
                                    contabilidade</p>
                            </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm">
                                ...
                                <tr>
                                    <th className="px-4 py-3 text-left font-medium text-muted-foreground whitespace-nowrap">Conta
                                        Bancária
                                    </th>
                                    <th className="px-4 py-3 text-left font-medium text-muted-foreground whitespace-nowrap">Data
                                        Pgto
                                    </th>
                                    <th className="px-4 py-3 text-left font-medium text-muted-foreground">Descrição</th>
                                    <th className="px-4 py-3 text-left font-medium text-muted-foreground whitespace-nowrap">Nome
                                        Cliente / Fornecedor
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td className="px-4 py-3 text-right">
                                        <div
                                            className="text-teal-400 font-bold text-xs">+{formatCurrency(totalEntradas)}</div>
                                        <div
                                            className="text-destructive font-bold text-xs">-{formatCurrency(totalSaidas)}</div>
                                    </td>
                                    <td/>
                                </tr>
                                </tfoot>
            ...
            {tab === "impostos" && (
                <div className="glass-panel rounded-2xl p-5">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span
                            className="text-sm font-bold text-destructive">{formatCurrency(totalImpostos)} a recolher</span>
                    </div>
                        ...
                        {impostos.map((imp, i) => (
                            <div key={i} className="flex items-center justify-between bg-white/5 rounded-xl p-4">
                                <div className="flex items-center gap-4">
                                    <span
                                        className="font-mono font-bold text-primary bg-primary/10 px-3 py-1 rounded-lg text-sm">{imp.nome}</span>
                                    <div>
                                        <p className="text-sm text-white">Base: <span
                                            className="font-medium">{formatCurrency(imp.base)}</span></p>
