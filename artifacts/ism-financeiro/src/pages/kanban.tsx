...
function CardMenu({
  ...
  return (
    <div ref={ref} className="relative" onClick={e => e.stopPropagation()}>
      ...
      {open && (
        <div className="absolute right-0 top-6 z-50 w-36 rounded-lg border border-white/10 bg-[#1E1E1E] shadow-xl py-1">
          <button
...
export default function Kanban() {
  ...
  const filteredCards = useMemo(() => {
    ...
    switch (activeFilter) {
      case "urgente":       result = result.filter(c => c.prioridade === "urgente"); break;
      case "alta":          result = result.filter(c => c.prioridade === "alta");    break;
      case "vencendo_hoje": {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4 px-1">
        ...
        <Button
          onClick={() => { setSelectedCard(null); setModalColuna("solicitado"); setModalMode("create"); setModalOpen(true); }}
