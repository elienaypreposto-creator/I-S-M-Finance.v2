...
export default function Filiais() {
  ...
  const openCreate = () => { setEditingFilial(null); setModalKey((k) => k + 1); };
  const openEdit = (f: FilialRow) => { setEditingFilial(f); setModalKey((k) => k + 1); };
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-2 mb-0.5">
                          ...
                          <span className="inline-flex items-center gap-1 text-xs bg-success/20 text-success px-2 py-0.5 rounded-full shrink-0">
