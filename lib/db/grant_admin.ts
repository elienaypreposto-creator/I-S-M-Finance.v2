...
async function grantAdmin() {
  ...
  const permissoesUI = [
    ...
    "financeiro:conciliacao:acessar", "financeiro:conciliacao:conciliar", "financeiro:conciliacao:importar",
    ...
    "financeiro:lancamentos:criar", "financeiro:lancamentos:listar", "financeiro:lancamentos:deletar",
